...
SERVICES: list[tuple] = [
    ...
    (1, "checkout-service",            "Team Alpha", "v3.2.0",  "pagerduty-alpha", "github.com/paylane/checkout-service",            "tier-0", 0, "Go"),
    (2, "payment-gateway-service",     "Team Alpha", "v2.4.1",  "pagerduty-alpha", "github.com/paylane/payment-gateway-service",     "tier-0", 0, "Go"),
    (3, "fraud-detection-service",     "Team Sigma", "v1.7.3",  "pagerduty-sigma", "github.com/paylane/fraud-detection-service",     "tier-0", 0, "Python"),
    (4, "ledger-service",              "Team Sigma", "v2.0.0",  "pagerduty-sigma", "github.com/paylane/ledger-service",              "tier-0", 0, "Kotlin"),
    (5, "user-profile-service",        "Team Beta",  "v2.5.2",  "pagerduty-beta",  "github.com/paylane/user-profile-service",        "tier-1", 0, "Python"),
    (6, "notification-service",        "Team Beta",  "v1.3.0",  "pagerduty-beta",  "github.com/paylane/notification-service",        "tier-1", 0, "Python"),
    (7, "webhook-dispatcher",          "Team Beta",  "v1.0.0",  "pagerduty-beta",  "github.com/paylane/webhook-dispatcher",          "tier-1", 0, "Go"),
    (8, "merchant-onboarding-service", "Team Delta", "v1.8.1",  "pagerduty-delta", "github.com/paylane/merchant-onboarding-service", "tier-2", 0, "TypeScript"),
    (9, "reporting-service",           "Team Delta", "v1.4.0",  "pagerduty-delta", "github.com/paylane/reporting-service",           "tier-2", 0, "Python"),
    (10, "legacy-inventory-service",   "Team Gamma", "v0.9.7",  "pagerduty-gamma", "github.com/paylane/legacy-inventory-service",    "tier-2", 1, "Go"),
]
...
ENDPOINTS: list[tuple] = [
    ...
    (9,  "/api/v1/fraud/feedback",               3, "POST", "Submit chargeback or fraud-confirmation feedback for retraining"),
    ...
    (24, "/api/v1/inventory/reserve",           10, "POST", "DEPRECATED — reserve stock (legacy commerce era)"),
]
...
INCIDENTS: list[tuple] = [
    ...
    (1,  1, "2024-11-29 13:14:00", "2024-11-29 14:42:00", "SEV-1", "Black Friday checkout 504 spike during peak traffic",                "PM-2024-001"),
    (2,  2, "2024-07-22 09:08:00", "2024-07-22 10:27:00", "SEV-2", "Payment-gateway-service authorization failures after Stripe credential rotation", "PM-2024-002"),
    (3,  3, "2024-05-14 16:00:00", "2024-05-15 02:00:00", "SEV-2", "Fraud model v1.7 regression — false positives on legitimate transactions", "PM-2024-003"),
    (4,  1, "2024-09-03 11:30:00", "2024-09-03 11:45:00", "SEV-3", "Kafka rebalance storm on checkout.events caused 5-minute consumer pause", "PM-2024-004"),
    (5,  7, "2024-08-19 22:01:00", "2024-08-20 00:30:00", "SEV-2", "Single merchant flooded webhook-dispatcher; queue saturation",         "PM-2024-005"),
    (6,  4, "2024-06-11 04:30:00", "2024-06-11 09:15:00", "SEV-1", "Currency rounding bug — half-cent truncation impacted EU merchants",   "PM-2024-006"),
    (7,  1, "2024-10-04 18:22:00", "2024-10-04 18:55:00", "SEV-2", "EKS deploy wedged the cluster; misconfigured pod disruption budget",  "PM-2024-007"),
    (8,  4, "2024-03-28 12:00:00", "2024-03-28 19:00:00", "SEV-1", "Ledger double-entry bug — settlement drift over 7 hours",             "PM-2024-008"),
    # Incidents without postmortems (recent or low-sev)
    (9,  5, "2025-02-12 03:20:00", "2025-02-12 03:40:00", "SEV-3", "user-profile-service latency spike during read-replica failover test",  None),
    (10, 6, "2025-01-30 14:10:00", "2025-01-30 14:25:00", "SEV-3", "notification-service Redis OOM during email blast",                    None),
    (11, 9, "2025-01-08 10:00:00", "2025-01-08 11:30:00", "SEV-3", "reporting-service ClickHouse slow queries blocking dashboards",        None),
    (12, 8, "2024-12-19 09:45:00", "2024-12-19 10:12:00", "SEV-3", "merchant-onboarding-service stuck applications in KYC review",        None),
    (13, 2, "2024-12-02 21:00:00", "2024-12-02 21:18:00", "SEV-3", "TLS certificate near-expiry alert on api.paylane.io",                  None),
    (14, 5, "2024-11-15 08:30:00", "2024-11-15 09:00:00", "SEV-3", "RDS connection pool exhaustion on user-profile",                       None),
    (15, 1, "2024-10-30 23:00:00", "2024-10-30 23:35:00", "SEV-3", "ArgoCD rolled back a bad checkout-service deploy",                     None),
]
